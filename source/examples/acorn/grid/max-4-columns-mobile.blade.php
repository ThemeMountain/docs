---
permalink: acorn/includes/grid/max-4-columns-mobile.html
search: false
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                        <tr>
                          <td class="col col-sm-2" width="168" style="padding: 0 8px;">
                            <p>2 cols on mobile <br><em style="color: #999999;">class="col col-sm-2"</em></p>
                          </td>
                          <td class="col col-sm-2" width="168" style="padding: 0 8px;">
                            <p>2 cols on mobile <br><em style="color: #999999;">class="col col-sm-2"</em></p>
                          </td>
                          <td class="col" width="168" style="padding: 0 8px;">
                              <p>Full width on mobile. This column breaks on the next line, because it only uses <em style="color: #999999;">class="col"</em></p>
                          </td>
                        </tr>
                      </table>
                    </td>

---
permalink: pine/examples/images/hide-on-desktop.html
search: false
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                        <tr>
                          <td class="col" width="640" style="padding: 0 10px;">
                            <h2 class="hide-sm" style="font-weight: 500;">Check the mobile preview to see the image</h2>
                            <div class="show-sm" style="display: none;">
                              <h2 style="font-weight: 500; margin-bottom: 5px;">Surprise!</h2>
                              <p style="margin-top: 0;">I'm a pug in a rug.</p>
                            </div>
                            <!--[if !mso]><!-->
                              <img class="show-sm" src="https://picsum.photos/640/400?image=1025" width="640" style="display: none; max-height: 0;">
                            <!--<![endif]-->
                          </td>
                        </tr>
                      </table>

---
permalink: pine/examples/images/outlook-bg-images.html
search: false
            ...
            <tr>
              <td align="left" bgcolor="#FFFFFF">
                ...
                <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                  <tr>
                    <td align="center" class="col px-sm-30" bgcolor="#1F2225" background="https://picsum.photos/1400/1000?image=307" style="background-image: url('https://picsum.photos/1400/1000?image=307'); background-repeat: no-repeat; background-position: center; background-size: cover;" width="100%">
                      <!--[if gte mso 9]>
                      <v:image src="https://picsum.photos/1400/1000?image=307" xmlns:v="urn:schemas-microsoft-com:vml" style="width:700px;height:500px;" />
                      <v:rect fill="false" stroke="false" style="position:absolute;width:700px;height:500px;">
                      <div>
                      <![endif]-->
                      <div class="spacer" style="line-height: 150px; height: 150px;">&zwnj;</div>
                      <p style="color: #FFFFFF; margin: 0;">ALSO WORKS IN</p>
                      <h1 style="color: #FFFFFF; font-size: 40px; font-weight: 300; line-height: 40px; margin: 0 0 10px;">Outlook &amp; Windows Mail</h1>
                      <p style="color: #FFFFFF; margin: 0;">AND IT'S RETINA, TOO!</p>
                      <div class="spacer" style="line-height: 150px; height: 150px;">&zwnj;</div>

---
permalink: pine/includes/components/spacer-universal.html
search: false
    ...
    <table class="wrapper" cellpadding="15" cellspacing="0" role="presentation" width="100%">
      <tr>
        <td align="center" bgcolor="#f1f5f8">
          ...
          <div class="spacer py-sm-20" style="line-height: 80px; background: #666666;">&zwnj;</div>

          <table class="container" cellpadding="0" cellspacing="0" role="presentation" width="700">
            <tr>
              <td align="left" bgcolor="#FFFFFF" style="padding: 0 20px;">
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                        <tr>
                          <td class="col" width="640" style="padding: 0 10px;">
                            <p>
                              The gray area above is an Universal Spacer added just before the Container table.
                            </p>
                            <p style="margin-bottom: 0;">
                              The ones below this text  is added inside a Column.
                            </p>
                            <div class="spacer py-sm-20" style="line-height: 80px; background: #666666;">&zwnj;</div>
                            <p style="margin-bottom: 0;">
                              While all spacers have been set to be 80px high on desktops and tablets,
                              the ones above will be reset to 40px high on mobile, through a spacing utility class.
                              However, the Spacer below overrides this with inline CSS height, and stays at 80px on mobile as well.
                            </p>
                            <div class="spacer" style="line-height: 80px; height: 80px; background: #666666;">&zwnj;</div>
                          </td>
                        </tr>
                      </table>
                    </td>

---
permalink: acorn/includes/utilities/reverse-2-col.html
search: false
---
                    ...
                    <td class="px-sm-16" style="padding: 0 24px;">
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                        <tr class="full-width-sm">
                          <td class="col stack-sm-last text-sm-center" width="260" style="padding: 0 8px; vertical-align: middle;">
                            <h2 style="font-weight: 300;">Last on Mobile</h2>
                            <p>Title and text will appear underneath the image, on mobile devices.</p>
                          </td>
                          <td class="col stack-sm-first" align="center" width="260" style="padding: 0 8px;">
                            <img src="https://picsum.photos/520/520?image=823" alt="Image from Unsplash" width="260">
                          </td>
                        </tr>
                      </table>
                      <div class="spacer py-sm-16" style="line-height: 32px;">&zwnj;</div>

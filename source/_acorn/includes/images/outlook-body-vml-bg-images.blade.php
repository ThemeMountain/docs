---
permalink: acorn/includes/images/outlook-body-vml-bg-images.html
search: false
---
...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style type="text/css">
      ...
      body {display: flex; align-items: center; background-image: url('/img/acorn/halftone-yellow.png'); background-repeat: repeat; background-position: center; overflow: hidden;}
  ...
  <body style="box-sizing:border-box;margin:0;padding:0;width:100%;word-break:break-word;-webkit-font-smoothing:antialiased;">
    ...
    <table class="wrapper" cellpadding="16" cellspacing="0" role="presentation" width="100%" background="/img/acorn/halftone-yellow.png" style="background-image: url('/img/acorn/halftone-yellow.png'); background-repeat: repeat; background-position: center;">
      <tr>
        <td align="center">
          <!--[if gte mso 9]>
            <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
              <v:fill type="tile" src="/img/acorn/halftone-yellow.png" />
            </v:background>
          <![endif]-->

<nav :aria-expanded="[showMobileMenu ? 'true' : 'false']" class="sidebar-navigation page-nav fixed md:relative h-full md:h-auto pin-t pin-r bg-white md:bg-transparent w-3/4 md:w-1/5 lg:w-2/5 pl-8 md:pl-0 pt-24 md:pt-0 md:mt-20 z-40 shadow-lg md:shadow-none transition-transform">
    <div class="fixed sticky md:top-20 pr-0 lg:pr-16 lg:min-w-64">
        <div class="overflow-y-auto wrapper scrolling-touch">
            <ul v-cloak class="pb-32 md:py-8 md:mt-6 list-reset">

        ...
        <div class="flex flex-1 items-center">
            <div class="w-2/5">
                <a href="{{ $page->getFirst()->getUrl() }}" class="flex float-left items-center hover:text-{{ $page->color }}">
                    ...
                    <h2 class="p-0 pl-3 text-base font-bold">
                            {{ $page->name }}
            ...
            <div class="w-full py-4">
                <div class="relative">
                    <input type="search" id="search" class="block w-full h-10 pl-10 pr-2 bg-white text-xs text tracking-wide placeholder-grey-darkest rounded border outline-0 focus:border-{{ $page->color }} focus:text-{{ $page->color }} transition-all" placeholder="Search documentation..." name="search" autocomplete="off" />
